...
make_logging = function(){
  ...
  c("// On First Setup",
    ...
    'private string myYear = FormatDateTime("%Y", Systime())',
    'private string myMonth = FormatDateTime("%m", Systime())',
    ...
    "endif",
    "",
    'logging.allChannels.strFileName = folder+filePrefix+FormatDateTime("%y%m%d_%H%M%S.csv",SysTime())',
    "",
